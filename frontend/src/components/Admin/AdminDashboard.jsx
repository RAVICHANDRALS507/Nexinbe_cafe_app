...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await axios.get(`${REACT_APP_BACKEND_URL}/api/admin/dashboard`);
        if (response.data) {
          setStats({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${REACT_APP_BACKEND_URL}/api/admin/add`, payload);
  ...
  const handleShowAdmins = async () => {
    try {
      const response = await axios.get(`${REACT_APP_BACKEND_URL}/api/admin/admins`); // Changed from /api/admins to /api/admin/admins
  ...
  const handleSaveUpdate = async () => {
    try {
      ...
      if (showPasswordFields) {
        ...
        const verifyResponse = await axios.post(`${REACT_APP_BACKEND_URL}/api/admin/verify-password`, {
      ...
      const response = await axios.put(
        `${REACT_APP_BACKEND_URL}/api/admin/update/${editingAdmin._id}`, 
        updateData
      );
  ...
  const handleDelete = async (adminId) => {
    if (window.confirm('Are you sure you want to delete this admin?')) {
      try {
        await axios.delete(`${REACT_APP_BACKEND_URL}/api/admin/delete/${adminId}`);
  ...
  const deleteStockItem = async (id) => {
    if (window.confirm("Are you sure you want to delete this item?")) {
      try {
        await axios.delete(`${REACT_APP_BACKEND_URL}/api/stock/delete/${id}`);
  ...
  const handleSaveStockUpdate = async () => {
    try {
      await axios.put(`${REACT_APP_BACKEND_URL}/api/menu/${editingStock._id}`, editStock);
